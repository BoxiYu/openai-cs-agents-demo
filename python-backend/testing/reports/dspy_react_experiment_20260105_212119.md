...
- simple_query: 100.00% (2 cases)
- medium: 50.00% (2 cases)
- complex: 50.00% (2 cases)
- edge_case: 50.00% (2 cases)
...
**Status:** ✗
**Tools used:** ['flight_status', 'flight_status', 'get_alternative_flights']
...
**Status:** ✓
**Tools used:** ['get_alternative_flights']
